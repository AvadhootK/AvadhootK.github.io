...
import self from "../assets/profilepic/image3.jpg";
      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-center md:items-center md:justify-center text-left px-6 pt-32 pb-24 space-y-10 md:space-y-0 md:space-x-16">
        ...
        <div className="text-left">
          ...
          <p className="text-gray-dark text-base mb-6 max-w-xl">
            {/* I design and build intelligent systems, blending research and engineering to solve real-world problems. */}
            I explore cutting-edge research and bring it to life through intelligent systems, blending research and engineering to solve real-world problems.
          </p>
